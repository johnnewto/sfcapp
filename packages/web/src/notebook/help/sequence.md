...
Stock-flow diagram cells are a related inspection view: they draw a tank-and-pipe scene from the same transactions-flow and balance-sheet matrices, bound to the selected run period.
